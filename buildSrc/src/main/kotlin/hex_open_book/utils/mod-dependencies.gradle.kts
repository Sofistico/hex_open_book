...
abstract class HexOpenBookModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexOpenBookModDependenciesExtension>("hexopenbookModDependencies")
