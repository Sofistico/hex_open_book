...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hex_open_book.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hex_open_book-common-common-refmap.json
        // fixed:   hex_open_book-common.refmap.json
