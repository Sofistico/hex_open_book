...
loom {
    forge {
        ...
        mixinConfig(
            "hex_open_book-common.mixins.json",
            "hex_open_book-forge.mixins.json",
        )
    }
    ...
    runs {
        register("commonDatagen") {
            ...
            property("hex_open_book.apply-datagen-mixin", "true")
        }
    }
}

hexopenbookModDependencies {
