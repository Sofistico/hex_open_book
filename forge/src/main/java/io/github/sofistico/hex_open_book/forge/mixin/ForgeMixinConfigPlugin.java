...
public class ForgeMixinConfigPlugin implements IMixinConfigPlugin {
    ...
    public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
        if (mixinClassName.equals("io.github.sofistico.hex_open_book.forge.mixin.MixinDatagenMain")) {
            var shouldApply = System.getProperty("hex_open_book.apply-datagen-mixin", "false").equals("true");
            if (shouldApply) {
                HexOpenBook.LOGGER.warn("Applying scuffed datagen mixin. This should not happen if not running datagen!");
            }
            return shouldApply;
        }
        return true;
